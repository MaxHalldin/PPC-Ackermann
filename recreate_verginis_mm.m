...
function [res,u] = ydotPPCtest(t,y,ref,params)
    ...
    r = params.r_inf + (params.r0 - params.r_inf)*exp(-params.lo*t);
    ...
    s = params.a*sat(params.T*e, params.ebar);
